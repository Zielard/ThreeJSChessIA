function engineGame(options) {
    ...
    var engine = typeof STOCKFISH === "function" ? STOCKFISH() : new Worker('js/stockfish/stockfish.js');
    var evaler = typeof STOCKFISH === "function" ? STOCKFISH() : new Worker('js/stockfish/stockfish.js');
    var engineStatus = {};
    ...
    {
        var moves = '';
        for(var i = 0; i < mHistory.length; ++i) {
            var move = mHistory[i];
            moves += (' ' + move);
        }
        return moves;
    ...
    engine.onmessage = function(event) {
        ...
        if(line == 'uciok') {
            ...
            if(match) {
                ...
                changeEnemyPos(match[1],match[2]);
